...
namespace coup{
    ...
    vector<string> Player::getValidActions() const{
        ...
        vector<string> validActions{"gather", "tax", "bribe", "arrest", "sanction", "coup"}; 
        ...
        // add endTurn to the vector
        validActions.push_back("endTurn");
    ...
    void Player::endTurn(){
        ...
        // after ending their turn, the player's last action should be cleared to stop
        // another player from undoing their action after the turn ended
        this->_lastAction = ""; // clears the last action performed by this player
    }
